...
- Upper Push：健身房版使用热身 A；肩不适优先 B；赶时间改做居家版并采用 4-1-2 节奏。附加：左肩外旋/肩胛下沉控制 1 组。
- Upper Pull：健身房版热身 A；颈肩紧张改 B；居家版建议先做毛巾等长拉再进入主循环。
- Lower 1（Squat）：健身房版热身 A；膝关节敏感用 B；居家版则改以单腿与节奏控制。附加：侧向弹力带走 1 组（无弹力带 → 侧步 12/侧）。
